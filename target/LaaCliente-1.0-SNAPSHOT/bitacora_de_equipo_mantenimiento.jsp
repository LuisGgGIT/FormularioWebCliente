<%-- 
    Document   : bitacora_de_equipo_mantenimiento
    Author     : celi Diaz
    vesion     : 1.0
--%>
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <center>   <div class="panel-heading">Bitacora de equipos servicio/Mantenimiento</div></center>
                            </div>
                            <hr>
                        </div>
                    </div> 
                            ...
                            <div class="col-sm-12">
                                <div class="white-box">
                                    ...
                                    <div class="table-responsive">
                                        <table id="tablaEquipoMantenimiento" class="display nowrap" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        N°
                                            ...
                                            <tbody id="listaEquipoMantenimiento">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label for="message-text" class="control-label">Nombre del equpo</label>
                                <input type="text" class="form-control" id="insertarNombreequipo">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Numero de inventario</label>
                                <input type="text" class="form-control" id="insertarNumeroinvetario">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha de entrega</label>
                                <input type="text" id="insertarFechaEntrega" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Cambios</label>
                                <input type="text" class="form-control" id="insertarCambios">
                            </div>
                            <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label for="message-text" class="control-label">Nombre del equpo</label>
                                <input type="text" class="form-control" id="editandoNombreequipo">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Numero de inventario</label>
                                <input type="text" class="form-control" id="editandoNumeroinvetario">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Observaciones</label>
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Fecha de entrega</label>
                                <input type="text" id="editandoFechaEntrega" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="recipient-name" class="control-label">Cambios</label>
                                <input type="text" class="form-control" id="editandoCambios">
                            </div>
                            <div class="form-group">
        ...
        <script >
            ...
            $(document).ready(function () {
                ...
                RecuperarListaEquipoMantenimiento();
                function RecuperarListaEquipoMantenimiento() {
                    $.ajax({
                        url: localStorage.getItem("urlproyecto") + 'LaaServicio/ruta/servicioListas/lista_bitacora_de_equipoMatenimiento',
                        data: {
                            idlaboratorio: idlab
                        },
                        type: 'GET',
                        dataType: 'json',
                        success: function (data) {
                            $("#listaEquipoMantenimiento").empty();
                            for (var ad in data) {
                                generartabla(data[ad].id_bitacora_servicio_mantenimiento, ad, data[ad].fecha, data[ad].nombre_equipo, data[ad].numero_inventario, data[ad].observaciones, data[ad].fecha_entrega, data[ad].cambios, data[ad].id_laboratorio);
                            }
                        },
                        error: function (jqXHR, status, error) {
                        ...
                        complete: function (jqXHR, status) {
                            ...
                            $("#tablaEquipoMantenimiento").DataTable({
                                dom: 'Bfrtip',
                                buttons: [
                                    'excel'
                                ],
                ...
                function generartabla(id_bitacora_servicio_mantenimiento, ad, fecha, nombre_equipo, numero_inventario, observaciones, fecha_entrega, cambios, id_laboratorio) {
                    var nombrelaboratorio = document.getElementById('nombrelaboratorio').textContent;
                    var text = '<tr id="' + id_bitacora_servicio_mantenimiento + '">' +
                            '<td class="py-1">' + ++ad + ' </td>' +
                            '<td >' + fecha + '</td>' +
                            '<td>' + nombre_equipo + '</td>' +
                            ...
                            '<td style="text-align:center;" ><button  class="btn btn-success" onclick="editarBitacoraEquipoManteniento(' + id_bitacora_servicio_mantenimiento + ')"><i class="fa fa-edit"></i></button></td>' +
                            '<td style="text-align:center;" ><button class="btn btn-danger" onclick="eliminarBitacoraEquipoManteniento(' + id_bitacora_servicio_mantenimiento + ')" ><i class="icon-trash"></i></button></td>' +
                            '</tr>';
                    $("#listaEquipoMantenimiento").append(text);
                }
            });

            function editarBitacoraEquipoManteniento(id_bitacora_servicio_mantenimiento) {
                var nombrelaboratorio = document.getElementById('nombrelaboratorio').textContent;
                $.ajax({
                    url: localStorage.getItem("urlproyecto") + 'LaaServicio/ruta/servicioBuscar/buscarbitacoraequipomantenimiento',
                    data: {
                        id: id_bitacora_servicio_mantenimiento
                    },
                    type: 'GET',
                    dataType: 'json',
                    success: function (data) {
                        $("#editandoID").val(id_bitacora_servicio_mantenimiento);
                        $("#editandoFecha").val(data.fecha);
                        $("#editandoNombreequipo").val(data.nombre_equipo);
                        $("#editandoNumeroinvetario").val(data.numero_inventario);
                        $("#editandoObservaciones").val(data.observaciones);
                        $("#editandoFechaEntrega").val(data.fecha_entrega);
                        $("#editandoCambios").val(data.cambios);
            ...
            function Actualizar() {
                ...
                $.ajax({
                    url: localStorage.getItem("urlproyecto") + 'LaaServicio/ruta/servicioeditar/editarbitacora_de_equipo_mantenimiento',
                    data: {
                        id_bitacora_servicio_mantenimiento: $("#editandoID").val(),
                        fecha: $("#editandoFecha").val(),
                        nombre_equipo: $("#editandoNombreequipo").val(),
                        numero_inventario: $("#editandoNumeroinvetario").val(),
                        observaciones: $("#editandoObservaciones").val(),
                        fecha_entrega: $("#editandoFechaEntrega").val(),
                        cambios: $("#editandoCambios").val(),
...
// Read more about handling dismissals
                                ...
                                window.location.href = 'bitacora_de_equipo_mantenimiento.jsp?idlab=' + idlab;
                            });
            ...
            $("#btnInsertandoDatos").click(function () {
                ...
                var aux2 = $("#insertarNombreequipo").val();
                var aux3 = $("#insertarNumeroinvetario").val();
                var aux4 = $("#insertarObservaciones").val();
                var aux5 = $("#insertarFechaEntrega").val();
                var aux6 = $("#insertarCambios").val();

                if (aux1 != "" && aux2 != "" && aux3 != "" && aux4 != "" && aux5 != "" && aux6 != "") {
                    $.ajax({
                        url: localStorage.getItem("urlproyecto") + 'LaaServicio/ruta/servicioinsertar/insertarbitacora_de_equipo_mantenimiento',
                        data: {
                            fecha: $("#insertarFecha").val(),
                            nombre_equipo: $("#insertarNombreequipo").val(),
                            numero_inventario: $("#insertarNumeroinvetario").val(),
                            observaciones: $("#insertarObservaciones").val(),
                            fecha_entrega: $("#insertarFechaEntrega").val(),
                            cambios: $("#insertarCambios").val(),
                    ...
                    if ($.trim(aux2) === "") {
                        document.getElementById("insertarNombreequipo").style.borderColor = "red";
                    } else {
                        document.getElementById("insertarNombreequipo").style.borderColor = "#e4e7ea";
                    }
                    if ($.trim(aux3) === "") {
                        document.getElementById("insertarNumeroinvetario").style.borderColor = "red";
                    } else {
                        document.getElementById("insertarNumeroinvetario").style.borderColor = "#e4e7ea";
                    }
                    if ($.trim(aux4) === "") {
                    ...
                    if ($.trim(aux6) === "") {
                        document.getElementById("insertarCambios").style.borderColor = "red";
                    } else {
                        document.getElementById("insertarCambios").style.borderColor = "#e4e7ea";
                    }
            ...
            function eliminarBitacoraEquipoManteniento(id_bitacora_servicio_mantenimiento) {
                var iddato = id_bitacora_servicio_mantenimiento;
            ...
            function eliminando(iddato) {
                ...
                $.ajax({
                    url: localStorage.getItem("urlproyecto") + 'LaaServicio/ruta/servicioeliminar/eliminarbitacora_de_equipo_mantenimiento',
                    data: {
                        id_eliminar: iddato
                    },
                    type: 'GET',
